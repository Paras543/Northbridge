"""add consultations tracking table

Revision ID: ba7968bacab6
Revises: 99568eb8ed0d
Create Date: 2026-07-10 13:20:52.805511
...
revision: str = 'ba7968bacab6'
down_revision: Union[str, None] = '99568eb8ed0d'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_consultations_thread_id'), 'consultations', ['thread_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_consultations_thread_id'), table_name='consultations')
